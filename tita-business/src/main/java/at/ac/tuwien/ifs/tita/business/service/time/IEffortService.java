...
public interface IEffortService {
     ...
     * @throws PersistenceException if no timeEffort was found or another
     *         Exception is thrown
     * @return Effort found
     */
     ...
     * @throws PersistenceException if anything goes wrong with db access.
     */
    List<Effort> getEffortsDailyView(Date date, TiTAUser user) throws PersistenceException;
     ...
     * @throws PersistenceException if anything goes wrong with db access.
     */
    List<Effort> getEffortsMonthlyView(Integer year, Integer month, TiTAUser user) throws PersistenceException;
     ...
     */
    List<Integer> getEffortsYears(TiTAUser user);
     ...
     */
    Long findEffortsSumForIssueTrackerTask(TiTAProject tp, TiTAUser tu, Long issTProjectId, Long isstTTaskId,
            Long isstId);
     ...
     * @return a list of efforts
     */
    List<Effort> findEffortsForTiTAProjectAndTiTAUserOrdered(Long projectId, Long userId);
     ...
     * @return saved effort
     */
    Effort saveIssueTrackerTaskEfforts(Effort effort, ITaskTrackable task, TiTAUser user, TiTAProject project);
     ...
     * @return saved effort
     */
    Effort saveEffortForTiTATask(Effort effort, String description, TiTAUser user, TiTAProject project);
     ...
     * @return saved effort
     */
    Effort saveIssueTrackerTaskEfforts(Effort effort, Long isstTaskId, Long isstProjectId, String isstTaskDescription,
            TiTAUser user, Long titaProjectId);
