...
//        String description
    ...
    public void testfindEffortsForTiTAProjectIdShouldSucceed(){
        //CHECKSTYLE:OFF
        List<Effort> leff = this.timeEffortDAO.findEffortsForTiTAProjectId(this.tip1.getId());
    ...
    public void testfindEffortsForTiTAProjectIdAndTimeConsumerIdShouldSucceed(){
        //CHECKSTYLE:OFF
        List<Effort> leff = this.timeEffortDAO.findEffortsForTiTAProjectAndTimeConsumerId(
                                                                         this.tip1.getId(), this.us2.getId());
