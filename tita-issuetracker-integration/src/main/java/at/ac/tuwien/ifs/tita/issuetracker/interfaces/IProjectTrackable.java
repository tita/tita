...
/**
 * The interface describes the view on project objects from the integrated issue
...
public interface IProjectTrackable {
     ...
     * 
     * @param projectStatus
     *            - use the enumaration values for setting
     * @see ProjectStatus
     */
     ...
     * 
     * @param url
     *            - place on the file system(remote in most cases)
     */
    void setUrl(URL url);
     ...
     * @see ITaskTrackable
     */
    Map<Long, ITaskTrackable> getTasks();

    /**
     * Sets the viewState of the project.
     * 
     * @param viewState
     *            - public, private or any
     */
