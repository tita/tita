...
public class MantisBaseTest {
     ...
     */
    protected Long createTestProject(String projectName, String description, Boolean enabled,
     ...
     */
    protected Long createTestTask(String description, String summary, String projectName)
        throws MCException{
     ...
     */
    protected Long createTestComment(String text, boolean isPrivate, long issueId) 
        throws MCException{
