...
public interface ITimeEffortService {
     ...
     */
    List<TimeEffort> getTimeEffortsDailyView(Calendar cal)
            throws TitaDAOException;
     ...
     *             if anything goes wrong with db access.
     */
    List<TimeEffort> getTimeEffortsMonthlyView(Calendar cal)
            throws TitaDAOException;
     ...
     *             if anything goes wrong with db access.
     */
    List<TimeEffort> getActualTimeEfforts(int maxresults)
            throws TitaDAOException;
}
