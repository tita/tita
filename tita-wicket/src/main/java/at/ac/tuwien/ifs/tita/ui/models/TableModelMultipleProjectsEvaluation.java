...
public class TableModelMultipleProjectsEvaluation extends AbstractTableModel {
    ...
    // Logger
    private final Logger log = LoggerFactory.getLogger(TableModelMultipleProjectsEvaluation.class);
    private List<UserProjectEffort> list;


    public TableModelMultipleProjectsEvaluation(List<UserProjectEffort> list,
                                           String [] colNames) {
        this.list = list;
