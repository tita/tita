...
public class TimeEffortAdministrationPanel extends Panel {
    ...
    // // Logger
    // final Logger log =
    // LoggerFactory.getLogger(TimeEffortAdministrationPanel.class);
    //
    ...
    // teTimeLength.setModelObject(TiTATimeConverter.Duration2String(generalTimer.getDuration()));
    ...
    //
    // form = new Form<TimeEffort>("timeeffortForm", new
    // CompoundPropertyModel<TimeEffort>(new TimeEffort()));
    // add(form);
    ...
    // false);
    //
    // teDescription = new TextField<String>("tedescription", new
    // Model<String>(""));
    ...
    // form.add(teDate);
    //
    // teTimeLength = new TextField<String>("tetimelength", new
    // Model<String>(""));
    ...
    //
    // teStartTime = new TextField<String>("testarttime", new
    // Model<String>(""));
    ...
    //
    // protected TimeEffortDataView(String id, IDataProvider<TimeEffort>
    // dataProvider) {
    ...
    // CompoundPropertyModel<BaseTimeEffort>(item.getModel()));
    // TimeEffort timeEffort = (TimeEffort) item.getModelObject();
    //
    // Label lbDate = new Label("date",
    // GlobalUtils.DATEFORMAT.format(timeEffort.getDate()));
    //
    // Label lbDescription = new Label("description",
    // timeEffort.getDescription());
    //
    // Label lbStarttime = new Label("starttime", (timeEffort.getStartTime() ==
    // null ? ""
    ...
    //
    // Label lbLength = new Label("length", (timeEffort.getDuration() == null ?
    // "" : TiTATimeConverter
    ...
    //
    // teTimeLength.setModelObject(TiTATimeConverter.Duration2String(timeEffort.getDuration()));
    // teTimeLength.setOutputMarkupId(true);
    // target.addComponent(teTimeLength);
    //
    ...
    // target.addComponent(teStartTime);
    //
    // teEndTime.setModelObject(GlobalUtils.TIMEFORMAT24HOURS.format(timeEffort.getStartTime()
