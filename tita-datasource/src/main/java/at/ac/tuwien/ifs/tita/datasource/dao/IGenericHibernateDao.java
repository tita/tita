...
/**
 * This DAO has multiple access methods for all common dao functions for every entity type.
...
public interface IGenericHibernateDao<T, ID extends Serializable> 
    extends IPersistenceContextProvider{

    /**
     * Find an entity by ID.
     * @param id        id of entity
     * @param joinProps describe what many-asscociations should be read too.
