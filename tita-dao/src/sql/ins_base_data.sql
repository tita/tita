...
values (1, 'e1', 1, null, '2009-10-12', 2000, false, 6, 2000, 4000);
insert into EFFORT (ID, DESCRIPTION, TITA_TASK_ID, ISSUET_TASK_ID, DATE, DURATION, DELETED, USER_ID, START_TIME, END_TIME)
values (2, 'e2', 1, null, '2009-03-24', 2000, false, 6, 2000, 4000);

insert into EFFORT (ID, DESCRIPTION, TITA_TASK_ID, ISSUET_TASK_ID, DATE, DURATION, DELETED, USER_ID, START_TIME, END_TIME)
values (3, 'e3', 2, null, '2009-07-09', 2000, false, 6, 2000, 4000);
insert into EFFORT (ID, DESCRIPTION, TITA_TASK_ID, ISSUET_TASK_ID, DATE, DURATION, DELETED, USER_ID, START_TIME, END_TIME)
values (4, 'e4', 2, null, '2009-05-17', 2000, false, 6, 2000, 4000);
insert into EFFORT (ID, DESCRIPTION, TITA_TASK_ID, ISSUET_TASK_ID, DATE, DURATION, DELETED, USER_ID, START_TIME, END_TIME)
values (9, 'e9', 2, null, '2009-05-18', 3000, false, 6, 2000, 5000);

insert into EFFORT (ID, DESCRIPTION, TITA_TASK_ID, ISSUET_TASK_ID, DATE, DURATION, DELETED, USER_ID, START_TIME, END_TIME)
values (5, 'e5', null, 1, '2009-01-12', 2000, false, 6, 2000, 4000);
insert into EFFORT (ID, DESCRIPTION, TITA_TASK_ID, ISSUET_TASK_ID, DATE, DURATION, DELETED, USER_ID, START_TIME, END_TIME)
values (6, 'e6', null, 1, '2009-11-18', 2000, false, 6, 2000, 4000);

insert into EFFORT (ID, DESCRIPTION, TITA_TASK_ID, ISSUET_TASK_ID, DATE, DURATION, DELETED, USER_ID, START_TIME, END_TIME)
values (7, 'e7', null, 2, '2009-06-29', 2000, false, 6, 2000, 4000);
insert into EFFORT (ID, DESCRIPTION, TITA_TASK_ID, ISSUET_TASK_ID, DATE, DURATION, DELETED, USER_ID, START_TIME, END_TIME)
values (8, 'e8', null, 2, '2009-10-24', 2000, false, 6, 2000, 4000);
insert into EFFORT (ID, DESCRIPTION, TITA_TASK_ID, ISSUET_TASK_ID, DATE, DURATION, DELETED, USER_ID, START_TIME, END_TIME)
values (10, 'e10', null, 2, '2009-05-18', 3000, false, 6, 2000, 5000);
...
(3,1,789, 0);
insert into EFFORT (ID, DESCRIPTION, TITA_TASK_ID, ISSUET_TASK_ID, DATE, DURATION, DELETED, USER_ID, START_TIME, END_TIME)
values (11, 'e11', null, 3, '2010-01-06', 20000, false, 6, 2000, 5000);
insert into ISSUE_TRACKER_TASK (ID, ISSUE_TRACKER_PROJECT_ID, ISST_TASK_ID, MODIFICATION_VERSION) values
(4,1,785, 0);
insert into EFFORT (ID, DESCRIPTION, TITA_TASK_ID, ISSUET_TASK_ID, DATE, DURATION, DELETED, USER_ID, START_TIME, END_TIME)
values (13, 'e12', null, 4, '2010-01-07', 20000, false, 6, 2000, 5000);
