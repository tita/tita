...
insert into EFFORT (ID, DESCRIPTION, TITA_TASK_ID, ISSUET_TASK_ID, DATE, DURATION, DELETED, USER_ID, START_TIME, END_TIME)
values (5, 'e5', 1, null, '2009-01-12', 2000000, false, 6, 2000000, 4000000);
insert into EFFORT (ID, DESCRIPTION, TITA_TASK_ID, ISSUET_TASK_ID, DATE, DURATION, DELETED, USER_ID, START_TIME, END_TIME)
values (6, 'e6', 1, null, '2009-11-18', 2000000, false, 6, 2000000, 4000000);

insert into EFFORT (ID, DESCRIPTION, TITA_TASK_ID, ISSUET_TASK_ID, DATE, DURATION, DELETED, USER_ID, START_TIME, END_TIME)
values (7, 'e7', 2, null,  '2009-06-29', 2000000, false, 6, 2000000, 4000000);
insert into EFFORT (ID, DESCRIPTION, TITA_TASK_ID, ISSUET_TASK_ID, DATE, DURATION, DELETED, USER_ID, START_TIME, END_TIME)
values (8, 'e8', 2, null, '2009-10-24', 2000000, false, 6, 2000000, 4000000);
insert into EFFORT (ID, DESCRIPTION, TITA_TASK_ID, ISSUET_TASK_ID, DATE, DURATION, DELETED, USER_ID, START_TIME, END_TIME)
values (10, 'e10', 2, null ,'2009-05-18', 3000000, false, 6, 2000000, 5000000);
