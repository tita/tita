...
public interface IEffortDao extends IGenericHibernateDao<Effort, Long> {
     ...
     */
    Long findEffortsSumForIssueTrackerTask(Long tp, String username, Long issTProjectId, Long isstTTaskId, Long isstId);

    /**
     * Returns sum of Efforts per tita project, tita user and titaTask.
     * 
     * @param projectId Long
     * @param userId String
     * @param taskId Long
     * 
     * @return sum of duration of efforts from titaTasks.
     */
