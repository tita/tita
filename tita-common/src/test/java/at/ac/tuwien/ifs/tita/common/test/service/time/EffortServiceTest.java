...
import at.ac.tuwien.ifs.tita.common.service.time.IEffortService;
...
//    private final Logger log = LoggerFactory.getLogger(EffortServiceTest.class);
    ...
    private List<Effort> prepareEfforts(){
        ...
        try {
            service.saveEffort(timeEffort1);
            service.saveEffort(timeEffort2);
            service.saveEffort(timeEffort3);
        } catch (TitaDAOException e) {
            fail();
        }
        return effortList;
